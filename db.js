...
// Los datos se persisten en localStorage como un ArrayBuffer.
// ─────────────────────────────────────────────────────────────────────────────

const DB_KEY = 'inventario_db';
...
async function getDB() {
  ...
  // Si ya existe una BD guardada, la restauramos
  ...
  // Primera vez: crear el esquema y cargar los datos de ejemplo
...
window.DB = { getDB, query, run, saveDB };
